...
export default class addTrade extends React.Component {
    ...
    handleChange(e) {
        ...
        if(e.target.name === "quantity"){
            this.setState({
                totalQuantity: (Number(e.target.value) * 30).toString()
            }); 
        }
        ...
        if(e.target.name === "buyerName"){
            const { organisationsList,getOrganisation } = this.props.route.data;
            let buyerId = getOrganisation(organisationsList,{name : e.target.value});
            ...
            <div className="row">
                <form className="form-horizontal"  id="addTrade" name="addTrade" method="post" action="/listing" noValidate>
                    <div className="row">
                        ...
                        <div className="form-group col-md-6" >
                            <label htmlFor="ownerName" id="ownerNameLabel" className="col-sm-6 control-label">Trade Origin</label>
                            <div className="col-sm-6">
                        ...
                        <div className="form-group col-md-6" >
                            ...
                            <div className="col-sm-6">
                                <select name="buyerName" className="form-control" id="buyerName" ref="buyerName" onChange={ this.handleChange } required>
